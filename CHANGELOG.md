...
### Added
 ...
 - Improve Wine command runtime drastically when bwrap is enabled. This is achieved by launching a background wineserver and keeping it alive for the duration of the Protontricks session.
