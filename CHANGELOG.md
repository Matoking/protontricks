...
### Added
 ...
 - Add support for Steam Frame game compatibility profiles for Proton discovery
...
### Fixed
 ...
 - Fix crash caused by minimal appmanifest files which can be generated by tools like _NonSteamLaunchers Docky Loader Version_
